...
$1+i$的辐角有多个，表示为$\theta_0+2k\pi,\theta _0=arg(\frac{y}{x})=\frac{\pi}{4}$，选D  
...
5、 $\frac{e^z}{z(z^2-1)(\sin \pi z-1)}$零点$z=-1,0,1,k(k\neq-1,0,1)$  
$z=-1$是$z,(z^2-1),(\sin \pi z-1)$的一级零点  
$z=1$是$z,(z^2-1),(\sin \pi z-1)$的一级零点  
$z=0$是$z,(\sin \pi z-1)$的一级零点，是$(z^2-1)$的二级零点  
